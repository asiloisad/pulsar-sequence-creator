...
module.exports = {
  ...
  config: {
    simulateCursorLength: {
      ...
      description: 'A count of items in simulate view',
      type: 'integer',
      default: 7,
      minimum: 1,
      maximum: 20,
  ...
  activate() {
    ...
    this.subscriptions.add(
      atom.commands.add('atom-workspace', {
        'sequential-creator:open': () => this.open(),
      }),
      atom.commands.add(this.view.element, {
        'sequential-creator:done': () => this.view.handleDone(),
        'sequential-creator:close': () => this.close(),
      }),
      atom.config.observe('sequential-creator.simulateCursorLength', (value) => {
        this.simulateCursorLength = value
      }),
      atom.config.observe('sequential-creator.alphabetSequence', (value) => {
